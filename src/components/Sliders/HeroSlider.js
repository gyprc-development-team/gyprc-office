...
export const slides = [
  ...
  {
    title: 'GYPRC - Education (TeacherCool) - Empowering Minds, Shaping Futures',
  ...
  },
  {
    ...
    subtitle: 'GYPRC - Fostering excellence, growth, and positive impact through synergy and innovation. Explore a vast array of information and prospects with GYPRC - Education. Our primary platform, TeacherCool.com, provides a vast array of IT-related courses. ',
    image: gypr,
  },
  {
...

  {
    ...
    subtitle: 'Whether you need permanent hires or temporary staff, we connect you with skilled professionals who fit your business perfectly.',
    buttonText: 'Talk to an Expert',
    image: Consulting,
  },
        ...
        <div className='container  mx-auto  flex justify-between max-sm:flex-col sm:flex-col lg:flex-row gap-30 lg:mt-[90px] relative max-sm:bg-navbg1 max-sm:pb-[200px]'>
              <div className='w-1/2 lg:h-[82vh]  py-2 sm:w-full max-sm:w-full bg-navbg1  justify-center items-center relative'>
                ...
                <div className='flex justify-center container mx-auto max-sm:mt-10 px-8 '>
                  <div>
                    <h1 className='sm:text-4xl  max-sm:text-2xl font-extrabold text-start leading-[60px]  inria-serif-bold text-white  '>{slide.title}</h1>
                    <h1 className='sm:text-4xl  max-sm:text-2xl mt-4 font-extrabold text-start leading-[60px] inria-serif-bold text-white '>{slide.title2}</h1>
              ...
              <div className='relative max-sm:top-[-0px] lg:right-[-40px] sm:w-full lg:w-auto  max-sm:px-6 '>
                <img className=' sm:h-[320px] lg:h-[520px] max-sm:h-[200px] lg:w-[1800px] border-4 border-white sm:w-full max-sm:w-full  shadow-lg shadow-gray-700 ' src={slide.image} alt='' />
              </div>
            </div>
        </div>
          </SwiperSlide>
